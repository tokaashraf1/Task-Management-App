...
function EditTask({ task }) {
  ...
  return (
    <div>
      {isEdit ? (
        <div className="absolute w-[25%] bg-white p-6 px-11 border rounded-2xl shadow-lg z-10 ">
          ...
          <div className="flex justify-between">
            ...
            <button
              className="bg-gray-300 py-2 rounded-md px-2 hover:bg-gray-500"
        ...
        <button
          className="px-3 py-1 bg-blue-500 text-white rounded-md px-2 hover:bg-blue-700 "
